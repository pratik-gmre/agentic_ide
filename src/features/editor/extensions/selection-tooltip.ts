  ...
  return [
    {
      ...
      create() {
        ...
        addToChatButton.className =
          "font-sans p-1 px-2  hover:bg-muted-foreground/10 rounded-sm";
        const quickEditButton = document.createElement("button");

        quickEditButton.className =
          "font-sans p-1 px-2  hover:bg-muted-foreground/10 flex items-center gap-1 rounded-sm";
        ...
        quickEditButtonShortcut.className = "opacity-60 text-sm";
